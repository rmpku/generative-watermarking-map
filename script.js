const I18N = {
  en: {
    ...
    footerText: "Built as a living research index · data-first · contribution-friendly",
    results: "records",
    public: "Public",
    official: "Official",
  ...
  zh: {
    navPapers: "论文",
    navStats: "统计",
    heroTitle: "生成式水印的 <em>持续更新文献地图。</em>",
    heroDescription: "聚焦扩散模型盲生成式水印的可检索论文索引，记录代码、单位、venue，以及从论文到实现的路径。",
    ...
    footerText: "持续更新的研究索引 · 数据优先 · 方便协作",
    results: "条记录",
    public: "公开",
    official: "官方",
    thirdParty: "第三方",
